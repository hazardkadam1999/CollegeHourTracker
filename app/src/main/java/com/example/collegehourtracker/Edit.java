...
public class Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      TextView prn1=(TextView) findViewById(R.id.prn);
       ...
       EditText num2=(EditText) findViewById(R.id.num);
        ...
        delete1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String ph=num2.getText().toString();
                ...
                try {
                    ...
                    if (connection[0] != null) {
                        ...
                        try {
                            ...
                            statement[0] = connection[0].createStatement();
                            statement[0].executeUpdate("Update Student set NAME='"+nm+"' ,PHONE='"+ph+"' where PRN='"+eprn1[0]+"'");
                            err.setText("");
